<div class="col-lg-3 col-md-6 col-sm-12 mb-3">
    <div class="card shadow-lg" style="background-color: #{{ $project->color->HEX }}AA">
        <div class="card-img-top banner-image">
            <img src="{{ $project->image }}" onerror="this.src='{{ asset('images/homepagewallpaper.jpg') }}'" class="img-fluid" alt="Project Image">
          </div>
        <div class="card-body px-3 fw-medium">
            <h4 class="m-3 text-center">{{ Illuminate\Support\Str::limit($project->name, 26, '...') }}</h4>
