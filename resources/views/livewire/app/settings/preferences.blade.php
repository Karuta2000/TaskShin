<div class="container">
    <div class="row justify-content-center">
        ...
        <div class="col-md-8 card py-3 shadow">
            ...
            <div class="form-group row">
                <label for="defaultProject" class="col-md-4 col-form-label text-md-right">Default Project:</label>
                <div class="col-md-6">
                    <select class="form-control @error('preferences.project_id') is-invalid @enderror"
                        id="defaultProject" wire:model="preferences.project_id">
                        @php
            ...
            <div class="form-group row">
                <label class="col-md-4 col-form-label text-md-right">Set due date:</label>
                <div class="col-md-6">
